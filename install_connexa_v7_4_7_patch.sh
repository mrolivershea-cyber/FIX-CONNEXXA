...
echo "════════════════════════════════════════════════════════════════"
echo "  CONNEXA v7.4.7 - STABILITY AND PPTP AUTHENTICATION FIXES"
echo "  Date: $(date '+%Y-%m-%d %H:%M:%S UTC')"
echo "  User: mrolivershea-cyber"
echo "  Updates: Enhanced MSCHAP-V2, watchdog recovery, SQL fixes"
echo "════════════════════════════════════════════════════════════════"
...
# ============================================================================
echo ""
echo "📦 [Step 4/9] Installing pptp_tunnel_manager.py v7.4.7..."
...
class PPTPTunnelManager:
    ...
    def __init__(self):
        ...
        logger.info(f"PPTPTunnelManager v7.4.7 initialized")
    ...
    def create_tunnel(self, node_ip: str, username: str, password: str, 
        ...
        logger.info(f"[v7.4.7] Creating tunnel for node {node_id} ({node_ip})")
...
echo "✅ pptp_tunnel_manager.py v7.4.7 installed"

# ============================================================================
# STEP 5: Install Watchdog Monitor (FIX #5)
# ============================================================================
echo ""
echo "📦 [Step 5/9] Installing watchdog.py v7.4.7..."
...
class WatchdogMonitor:
    ...
    def __init__(self, check_interval: int = 30):
        ...
        logger.info(f"WatchdogMonitor v7.4.7 initialized (check_interval={check_interval}s)")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='CONNEXA Watchdog Monitor v7.4.7')
    parser.add_argument(
        '--interval',
        type=int,
        default=30,
...
echo "✅ watchdog.py v7.4.7 installed"
...
echo ""
echo "✅ CONNEXA v7.4.7 Critical Fixes Installed"
echo ""
echo "Fixes Applied:"
...
echo "  - See docs/v7.4.7-fixes.md for detailed information"
echo "  - See SECURITY.md for security considerations"

echo ""
echo "════════════════════════════════════════════════════════════════"
echo "  ✅ CONNEXA v7.4.7 PATCH INSTALLATION COMPLETE"
echo "════════════════════════════════════════════════════════════════"

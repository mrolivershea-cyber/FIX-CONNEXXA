...
echo "════════════════════════════════════════════════════════════════"
echo "  CONNEXA v7.4.9 - PRODUCTION-VALIDATED MULTI-TUNNEL FIX"
...
# ============================================================================
# STEP 1: Configure GRE firewall rules (FIX #7 - CRITICAL for v7.4.9)
# ============================================================================
echo ""
...
# ============================================================================
# STEP 5: Install PPTP Tunnel Manager v7.4.9
# ============================================================================
echo ""
echo "📦 [Step 5/10] Installing pptp_tunnel_manager.py v7.4.9..."

# Copy from repository
cp app/backend/pptp_tunnel_manager.py /app/backend/pptp_tunnel_manager.py
chmod 644 /app/backend/pptp_tunnel_manager.py

echo "✅ PPTP Tunnel Manager v7.4.9 installed"

# ============================================================================
# STEP 6: Install Watchdog v7.4.9
# ============================================================================
echo ""
echo "📦 [Step 6/10] Installing watchdog.py v7.4.9..."

# Copy from repository
cp app/backend/watchdog.py /app/backend/watchdog.py
chmod 644 /app/backend/watchdog.py

echo "✅ Watchdog v7.4.9 installed"
...
echo ""
echo "════════════════════════════════════════════════════════════════"
echo "  CONNEXA v7.4.9 Installation Complete!"
echo "════════════════════════════════════════════════════════════════"
echo ""
echo "Next steps:"
